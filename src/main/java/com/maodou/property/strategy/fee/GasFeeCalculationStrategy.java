...
public class GasFeeCalculationStrategy implements FeeCalculationStrategy {
    ...
    public BigDecimal calculateFee(FeeCalculationContext context) {
        ...
        BigDecimal tier1Limit = configService.getDecimalConfig("gas_fee_tier1_limit");
        BigDecimal tier2Limit = configService.getDecimalConfig("gas_fee_tier2_limit");
        BigDecimal tier1Price = configService.getDecimalConfig("gas_fee_tier1_price");
        BigDecimal tier2Price = configService.getDecimalConfig("gas_fee_tier2_price");
        BigDecimal tier3Price = configService.getDecimalConfig("gas_fee_tier3_price");
