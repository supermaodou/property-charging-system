...
(
    ...
    `bill_type`    VARCHAR(20)    NOT NULL COMMENT '账单类型(PROPERTY_FEE-物业费,WATER_FEE-水费,ELECTRIC_FEE-电费,GAS_FEE-燃气费,PARKING_FEE-停车费)',
...
VALUES ('property_fee_unit_price', '2.5', 'NUMBER', '物业费单价(元/平方米)'),
